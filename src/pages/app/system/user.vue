<template>
  <div class="main-content">
    ...
    <div class="search-box">
      <el-form label-position="left" label-width="80px" :inline="true" size="mini">
        ...
        <el-form-item  label="创建时间" class="start-time">
          <el-date-picker size="mini" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date"  v-model="pageObject.startTime"></el-date-picker>
          <span>-</span>
          <el-date-picker size="mini" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date"  v-model="pageObject.endTime"></el-date-picker>
        </el-form-item>
        <el-form-item>
...
<script>
  import { userList } from '@/services/AppServiceRequest';
  export default {
    data () {
      return {
        searchKey: '',
