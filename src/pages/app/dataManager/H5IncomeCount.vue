<template>
  <div class="pageWidth">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/dataManager/h5incomecount' }">数据统计管理</el-breadcrumb-item>
      <el-breadcrumb-item>H5营收统计</el-breadcrumb-item>
    </el-breadcrumb>
    <el-form class="formStyle" ref="form" :model="form" label-position="right" label-width="110px" size="mini"
             :inline="true">
      <el-form-item label="聚合页机构名称">
