...
// 查看名单来源 /converge/uvListDetail
export function convergeUvListDetail (data) {
  return Request.get('/converge/uvListDetail', data);
}
...
// 新增或更新/globalVariable/MarketingPage/update
export function MarketingPageUpdate (data) {
  return Request.post('/globalVariable/MarketingPage/update', data);
}
